...
Отримати інформацію про minimalStep.amount
  ${value}=    Get Value           xpath=//*[@id='mForm:lotStep0']
...
Отримати інформацію про complaintPeriod.endDate
  ...
  ${return_value}=    publicbid_service.parse_complaintPeriod_date    ${return_value}
  [return]  ${return_value}
...
Отримати інформацію про status
  ...
  ${return_value}=    publicbid_service.convert_status    ${return_value}
  [return]  ${return_value}
...
Отримати інформацію про items[0].classification.scheme
  ${return_value}=  Get Text           xpath=(//*[@id="mForm:lotItems0:lotItem_0:item0"]/tbody/tr[3]/td/label)[1]
